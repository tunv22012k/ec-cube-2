 ...
 * OrderOptions
 *
 * @ORM\Table(name="dtb_order_options")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Plugin\ProductOptions\Repository\OrderOptionsRepository")
 */
class OrderOptions extends AbstractEntity
{
    /**
     * @var integer
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="Eccube\Entity\Order", inversedBy="OrderOptions")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="Plugin\ProductOptions\Entity\Options", inversedBy="OrderOptions")
     * @ORM\JoinColumns({
     ...
     * @param Order $Order
     */
    public function setCart(Order $Order)
    {
        $this->Order = $Order;
